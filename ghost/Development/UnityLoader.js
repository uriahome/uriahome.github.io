...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'uniuni.data';
    var REMOTE_PACKAGE_BASE = 'uniuni.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3007856;
      var PACKAGE_UUID = '1251f0a9-9af9-4346-99dc-bc6937b71d1a';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 221236, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(221236, 221883, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(221883, 225495, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(225495, 2105259, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2105259, 2980231, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2980231, 3007856, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_uniuni.data');

    };
    Module['addRunDependency']('datafile_uniuni.data');
